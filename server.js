...
(function() {
  var child_process, fs, http, logFileName, logStream, logToFile, onReady, port, routes, server, use,
    __slice = [].slice;
  ...
  logToFile = function() {
    var args, name, now, oldfile, _ref;
    ...
    return logStream.write("" + (JSON.stringify((_ref = [now]).concat.apply(_ref, args))) + "\n");
  };
